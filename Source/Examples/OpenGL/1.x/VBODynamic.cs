...
namespace Examples.Tutorial
{
    ...
    class T09_VBO_Dynamic : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            for (int i = MaxParticleCount - VisibleParticleCount; i < MaxParticleCount; i++)
            {
                ...
                else
                {
                    ...
                    Vector3.Multiply(ref ParticleAttributes[i].Direction, (float)e.Time.TotalSeconds, out temp);
        ...
        {
            this.Title = VisibleParticleCount + " Points. FPS: " + string.Format("{0:F}", 1.0 / e.Time.TotalSeconds);
