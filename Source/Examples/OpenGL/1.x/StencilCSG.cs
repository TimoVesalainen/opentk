...
namespace Examples.Tutorial
{
    ...
    partial class StencilCSG : GameWindow
    {
        ...
        {
            this.Title = WindowTitle + "  FPS: " + (1f / e.Time.TotalSeconds).ToString("0.");

            MySphereZOffset += (float)(e.Time.TotalSeconds * 3.1);
            MySphereXOffset += (float)(e.Time.TotalSeconds * 4.2);
